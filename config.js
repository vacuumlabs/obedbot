...
const config = {
  ...
  slack: {
    ...
    lunchChannelIdBR: process.env.OBEDBOT_CHANNEL_ID_BR || '',
    botId: process.env.OBEDBOT_BOT_ID || '',
  },
  auth: {
    thalieLogin: process.env.OBEDBOT_THALIE_LOGIN_NAME,
    thaliePassword: process.env.OBEDBOT_THALIE_LOGIN_PASS,
  },
  orderReaction: 'taco',
